...
当前玩家功能包括本人钱包、版本化商城、订单、流水、新玩家活动、可靠日/周任务、5 步新手引导、资源兑换记录和资源兑换点地图。处理中订单/兑换在页面可见时每 3 秒有界轮询并在终态停止；报价显示倒计时并在到期后禁用。兼容路径
...
- [05-玩家使用教程](05-玩家使用教程.md)：登录、活动、任务、购买、整单出售和异常状态处置。
