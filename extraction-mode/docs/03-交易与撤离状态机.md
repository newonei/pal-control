...
8. Control API 要求 Native hello 声明已批准的稳定 `inventory.consume` 能力、正确游戏/Steam build/MOD/协议/宿主 EXE 身份和 persistence 证据；当前 dev37-ro 为只读候选，或仅有旧 `inventory.consume.experimental` 时，都在发送前关闭闸门。
